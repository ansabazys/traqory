...
export function OverviewStatPanel({
  ...
  return (
    <motion.div
      className="flex h-full flex-col justify-between border border-zinc-900 bg-[#0a0a0a] p-5 pb-4"
      initial={{
        opacity: 0,
        y: 18,
      }}
    ...
    >
      <div>
        <motion.h3
          className="mb-2 font-mono text-[10px] uppercase tracking-widest text-[#888888]"
          initial={{
            opacity: 0,
            y: 10,
          }}
